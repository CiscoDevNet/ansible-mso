...
options:
  ...
  pod_settings_template:
    ...
    - This parameter is required when O(pod_settings) is used.
    type: str
  pod_settings_template_id:
    description:
    - The ID of the Pod Settings template.
    - This parameter is required when O(pod_settings_uuid) is used.
    type: str
  state:
    description:
...
- name: Update Pod Profile using name
  cisco.mso.ndo_pod_profile:
    host: mso_host
    username: admin
    password: SomeSecretPassword
...
- name: Update the Pod Profile using UUID
  cisco.mso.ndo_pod_profile:
    host: mso_host
    username: admin
    password: SomeSecretPassword
...
- name: Query the Pod Profile using name
  cisco.mso.ndo_pod_profile:
    host: mso_host
    username: admin
    password: SomeSecretPassword
...
- name: Query the Pod Profile using UUID
  cisco.mso.ndo_pod_profile:
    host: mso_host
    username: admin
    password: SomeSecretPassword
...
- name: Delete the Pod Profile using Name
  cisco.mso.ndo_pod_profile:
    host: mso_host
    username: admin
    password: SomeSecretPassword
...
- name: Delete the Pod Profile using UUID
  cisco.mso.ndo_pod_profile:
    host: mso_host
    username: admin
    password: SomeSecretPassword
