...
Release v2.12.0 of the ``ansible-mso`` collection on 2025-11-30.
...
- Add ndo_match_rule_policy, ndo_match_rule_prefix and ndo match_rule_community_term as new modules for configuring Match Rule Policies on NDO v5.1 and later.
...
- Add support for secondary address for all interface types and path attributes configuration in l3out templates with the ndo_l3out_secondary_ip module
- Added Route Map Policy for Route Control and context modules
- Added ndo_tenant_set_rule_policy module to manage Set Rule Policies in Tenant Templates
