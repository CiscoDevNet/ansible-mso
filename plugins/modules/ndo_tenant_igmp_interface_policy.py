...
def main():
    ...
    if uuid or name:
        ...
        if match:
            set_names_for_references(mso, match.details, reference_dict)
            mso.existing = mso.previous = copy.deepcopy(match.details)
    else:
        mso.existing = mso.previous = [
            set_names_for_references(mso, igmp_interface_policy, reference_dict) for igmp_interface_policy in existing_igmp_interface_policies
        ]
    ...
    if not module.check_mode and ops:
        ...
        set_names_for_references(mso, mso.proposed, reference_dict)
