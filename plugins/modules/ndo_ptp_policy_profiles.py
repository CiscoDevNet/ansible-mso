...
options:
  ...
  profile_template:
    ...
    - The default value is aes67-2015.
    type: str
    choices: [ aes67-2015, default, telecom-8275-1, smpte-2059-2 ]
  sync_interval:
    description:
  ...
  state:
    ...
    default: query
notes:
- The C(ptp_policy) must exist before using this module in your playbook.
  The M(cisco.mso.ndo_ptp_policy) module can be used for this.
