...
Release v2.11.0 of the ``ansible-mso`` collection on 2025-07-16.
...
- Add module ndo_l3out_node_static_route_next_hop to configure next hops for a static route in l3out templates
...
- Add module ndo_l3out_routed_sub_interface to configure nodes, routed port and port-channel sub-interfaces in l3out templates
...
- Add ndo_schema_template_contract_service_chain module
- Added ndo_fabric_span_session module for the Fabric Monitoring Access Policy template
- Added ndo_fabric_span_session_source to manage SPAN session sources
- Added ndo_fabric_span_session_source_filter module to manage the SPAN session source filter
